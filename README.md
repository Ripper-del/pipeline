   ...
   * Парсер TikTok:
    ...
    * Автоматизация и прогрев TikTok (через AdsPower):
      ...
      **Особенности автоматизатора:**
      ...
      - **Очеловеченные комментарии**: Бот оставляет короткие, сленговые комментарии без смайликов. При наличии ключа OpenAI ИИ генерирует комментарии под контекст описания видео. В противном случае используется встроенный словарь фраз на языке целевой страны.
